<div class="flex w-full flex-1 flex-col gap-4 rounded-xl">
    ...
    <div class="border rounded-md shadow p-4">
        <div class="grid md:grid-cols-3 gap-4">
            ...
            <div class="rounded-md border shadow">
                <div class="flex flex-col space-y-2 p-4">
                    <flux:heading size="lg" class="text-center">Program Notes</flux:heading>
                    <p
                        class="text-center text-2xl font-bold {{ $difference >= 0 ? 'text-green-600' : 'text-red-600' }}">
                        {{ number_format($difference, 0, ',', '.') }}</p>
                    <p class="text-center text-xs text-gray-500">Notes</p>
                </div>
            </div>
        </div>
    </div>
