<section class="w-full space-y-6">
    ...
    <x-users.layout :heading="__('Profile information')" :subheading="__('Update member profile information such as name, email, and others')">
        <div class="w-full">
            <form action="">
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <flux:input wire:model="form.birthOfPlace" type="text" label="Birth Place" placeholder="e.g. Jakarta" />
                    <flux:input wire:model="form.dateOfBirth" type="date" label="Birth Date" placeholder="Choose date" />
                    ...
                    <flux:input wire:model="form.lastEducation" type="text" label="Last Education" placeholder="e.g. S1" />
                    <flux:input wire:model="form.major" type="text" label="Major" placeholder="e.g. Informatics" />
                    <flux:input wire:model="form.job" type="text" label="Job" placeholder="eg.g. Software Engineer" />
                </div>
            </form>
        </div>
    </x-users.layout>
