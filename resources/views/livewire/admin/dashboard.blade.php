<div class="flex w-full min-h-screen flex-1 flex-col gap-4 rounded-xl">
    ...
    <div class="grid grid-cols-4 gap-4">
        ...
        <div class="rounded-md border shadow">
            <div class="flex flex-col items-center p-4 space-y-2 h-24">
                <flux:heading size="sm">Total Members</flux:heading>
                <flux:text class="text-4xl font-semibold" variant="strong">{{ $totalMembers }}</flux:text>
            </div>
            <flux:separator />
            <div class="p-4 flex justify-center">
                <flux:link :href="route('admin.members.index')" class="text-sm" wire:navigate>View details</flux:link>
